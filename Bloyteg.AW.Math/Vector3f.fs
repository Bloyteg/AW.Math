...
type Vector3f = 
    ...
    static member (+) (lhs : Vector3f, rhs : single) : Vector3f = Vector3.addScalar lhs rhs
    static member (+) (lhs : single, rhs : Vector3f) : Vector3f = Vector3.addScalar rhs lhs
    static member (+) (lhs : Vector3f, rhs : Vector3f) : Vector3f = Vector3.addPointwise lhs rhs
    static member (-) (lhs : Vector3f, rhs : single) : Vector3f = Vector3.subtractScalar lhs rhs
    static member (-) (lhs : Vector3f, rhs : Vector3f) : Vector3f = Vector3.subtractPointwise lhs rhs
    ...
    static member (*) (lhs : Vector3f, rhs : Vector3f) : Vector3f = Vector3.multiplyPointwise lhs rhs
    static member (/) (lhs : Vector3f, rhs : single) : Vector3f = Vector3.divideScalar lhs rhs
    static member (/) (lhs : Vector3f, rhs : Vector3f) : Vector3f = Vector3.dividePointwise lhs rhs
